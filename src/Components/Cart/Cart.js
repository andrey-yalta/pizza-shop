                 ...
                 <div className="container container--cart">
                     {totalCount?  <div className="cart">
                         ...
                         <div className="content__items">
                             {/*<CartItem />*/}
                             {addedPizzas.map(obj=><CartItem  onMinus={onMinusItem} onPlus={onPlusItem} key={`${obj.id}_${obj.name}`}  id={obj.id} onRemove ={onRemoveItem}  imageUrl={obj.imageUrl}  totalCount ={items[obj.id].items.length} name = {obj.name} type={obj.type} size ={obj.size} totalPrice={items[obj.id].totalPrice}/>)}
